    ...
    <>
      ...
      <section className="mb-10">
        <h1 className="text-3xl font-bold text-white sm:text-4xl lg:text-5xl">
          ...
          <span style={{ color: "var(--accent)" }}>Find Trusted Local Pros</span>
        </h1>
        <p className="mt-3 text-lg text-zinc-400 max-w-2xl">
          Compare prices from licensed tradespeople in your area. Free, no obligation.
        </p>
        <div className="mt-6 flex flex-wrap items-center gap-4">
          <a
            href="https://tradihubai.com.au/jobs/new?trade=renovations&ref=propertyhub"
      ...
      {/* Bottom CTA */}
      <QuoteCTA position="bottom" category="renovation" />
